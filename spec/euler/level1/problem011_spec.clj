...
(def big-grid (vec (map #(Integer/parseInt %) 
               [
...
(describe 
  ...
  (it "Solves #11"
    (should= 70600674 (euler-11 big-grid)))

  (it "indexes the array with coordinates"
      (should= 8 (from-coords big-grid 0 0))
      (should= 49 (from-coords big-grid 0 1))
      (should= 36 (from-coords big-grid 1 9))
      (should= 15 (from-coords big-grid 5 0))
      )
